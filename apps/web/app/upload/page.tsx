*** Begin Patch
*** Update File: app/upload/page.tsx
@@
-// ./app/upload/page.tsx
+// ./app/upload/page.tsx
 +"use client";
...
+ // root app -> monorepo web lib: go up two levels to repo root, then into apps/web/lib
+ import { uploadArchive } from "../../apps/web/lib/api";
+ import FileDrop from "../../apps/web/components/FileDrop";
+ import { saveJob } from "../../apps/web/lib/history";
+ 
